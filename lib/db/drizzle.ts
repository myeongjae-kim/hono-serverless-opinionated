...
export const dbPrimary = drizzle(env.DB_PRIMARY_URL, {
  schema,
  mode: "default",
});
export const dbReplica = drizzle(env.DB_REPLICA_URL, {
  schema,
  mode: "default",
});
...
export const selectDbClient = (args?: SqlOptions): DatabaseClient =>
  args?.useReplica ? dbReplica : dbPrimary;
